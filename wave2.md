...
const PerlinNoiseVisualizer: React.FC<PerlinNoiseVisualizerProps> = ({
    ...
    useEffect(() => {
        ...
        renderer.toneMapping = THREE.NoToneMapping; // Disable tone mapping to preserve transparency
        ...
        const material = new THREE.ShaderMaterial({
            ...
            wireframe: true,
            transparent: true,
            blending: THREE.AdditiveBlending, // Use additive blending for glow without darkening background
            depthWrite: false, // Don't write to depth buffer to maintain transparency
        });
