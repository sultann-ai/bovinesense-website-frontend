...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - BovineSense | Innovation at its Core</title>
        <meta name="description" content="Discover BovineSense' revolutionary approach to AI-powered solutions, our visionary team, and the cutting-edge technology that's reshaping the future of business." />
      </Helmet>
        ...
        <HeroBgWrapper>
          ...
          >
            ...
            >
              ...
              >
                We exist to solve complex industrial and commercial challenges by engineering intelligent, end-to-end technology ecosystems. We drive tangible transformation by seamlessly connecting physical environments with digital intelligence.
              </motion.p>
                ...
                <FloatingCard className="p-12 h-full" delay={0.2}>
                  <div className="flex max-sm:flex-col max-sm:items-center max-sm:gap-5 items-start sm:space-x-6">
                    ...
                    <div className="flex-1">
                      ...
                      Our mission is to revolutionize industries from the ground up. We do this by developing our own cutting-edge agritech solutions, from smart IoT monitoring devices to integrated digital marketplaces while simultaneously empowering businesses worldwide with custom AI architectures, web platforms, and hardware engineering that drive efficiency and growth.
                      </p>
                ...
                <FloatingCard className="p-6 sm:p-12 h-full" delay={0.4}>
                  <div className="flex items-start sm:space-x-6 max-sm:flex-col max-sm:items-center max-sm:gap-5 ">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                      To become a global technology leader that sets the standard for how proprietary product ecosystems and custom technical services can seamlessly merge. We envision a future where our robust hardware and intelligent software solutions shape the operational backbone of agriculture, commerce, and enterprise infrastructure.
                      </p>
                      <div className="space-y-3">
                        {[
...
const coreValuesData = [
  {
    ...
    description: 'We push the boundaries of what is possible, channeling our expertise into both groundbreaking proprietary products and custom, revolutionary solutions for our clients.',
    icon: (
  ...
  },
  {
    ...
    description: 'Whether building rugged edge devices for harsh environments or deploying scalable cloud architectures, we maintain uncompromising standards to ensure resilience and reliability.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'We believe in the power of connected communities. From building marketplaces that link buyers, sellers, and service providers, to partnering closely with enterprise clients, we achieve extraordinary outcomes together.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'We foster a culture of relentless curiosity, continually evolving our multidisciplinary skill sets in AI, software development, and hardware design to stay ahead of rapid industry shifts.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Client and Community Success',
    description: 'Your success and the success of the industries we serve is our mission. We engineer end-to-end solutions designed to lower risks, optimize operations, and deliver measurable, lasting impact.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'We think beyond today\'s quick fixes, anticipating tomorrow\'s challenges to build agile, intelligent systems that stand the test of time.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
