...
const HeroBgWrapper: React.FC<HeroBgWrapperProps> = ({ children, className = "" }) => {
  return (
    <section className={`relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-primary-50 to-secondary-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 ${className}`}>
