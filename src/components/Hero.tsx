...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-primary-50 to-secondary-50 dark:from-[#06101f] dark:via-[#0a1b33] dark:to-[#102746] pt-12 md:pt-14">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-purple-500/20 to-pink-500/20 dark:from-[#17345a]/30 dark:to-[#0d2b4f]/20 rounded-full blur-3xl animate-bounce-slow" style={{ animationDelay: '1s' }}></div>
...
{/* @ts-ignore */}
      ...
      <div className="relative z-10 w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-slate-300 mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          >
            {[FaCode, FaBrain].map((Icon, index) => (
              <div
                key={index}
                className="w-16 h-16 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-gray-200 dark:border-slate-600 rounded-2xl flex items-center justify-center group hover:bg-white dark:hover:bg-slate-700 transition-all duration-300"
              >
                <Icon className="text-2xl text-gray-600 dark:text-slate-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 group-hover:scale-110 transition-all duration-300" />
              </div>
            ))}
          </motion.div>
        </motion.div>
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="group text-center bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-gray-200 dark:border-slate-600 rounded-2xl p-6 hover:bg-white dark:hover:bg-slate-700 transition-all duration-300"
            >
              ...
              <div className="text-sm md:text-base text-gray-600 dark:text-slate-300 group-hover:text-gray-900 dark:group-hover:text-slate-100 transition-colors">
                {stat.label}
              </div>
            </motion.div>
          ))}
